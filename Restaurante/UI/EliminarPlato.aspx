<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterRestaurante.Master" CodeBehind="EliminarPlato.aspx.vb" Inherits="UI.EliminarPlato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpo" runat="server">
     ...
     <div class="container col-sm-8 col-md-offset-2"  style="background-color:firebrick">
          <div class="container col-md-4 col-sm-offset-4"  style="background-color:firebrick">
                <h2 style="color:beige" class="text-center">Eliminar Plato</h2>
               <asp:TextBox ID="txtCodigo" CssClass="form-control" placeholder="Código del Plato" runat="server"></asp:TextBox>
               <div class="text-center margin-up-button">
                <asp:Button ID="btnEliminarPlato" Cssclass="btn btn-success text-center" runat="server" Text="Eliminar Plato" />  
                </div>
          </div>
